...
## Study 2
Analyze the average reward per step for agents ow learnt with the DDPG algorithm on the environments when the number of dimensions increases.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEzMzE2NDUzMSwtMTM3MDc5NDM3MiwyMD
ExOTcyMDQ0XX0=
-->