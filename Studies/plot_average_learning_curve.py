...
if __name__ == "__main__":
    ...
    for i,x in enumerate(xs):
        ...
        plt.title('Reward per step ; '+ args.title +' {}'.format(float(x)),fontsize=14)
        plt.xlabel("timesteps",fontsize=14)
        plt.ylabel("reward/step",fontsize=14)
    ...
    def animate(i):
        ...
        ax.set_title('Reward per step ; '+ args.title +' {}'.format(float(xs[i])),fontsize=14)
        ax.set_xlabel("timesteps",fontsize=14)
        ax.set_ylabel("reward/step",fontsize=14)
